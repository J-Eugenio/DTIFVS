...
<body>
  ...
  <div class="content-wrapper">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="page-head-line">Cadastro de Usuários</h1>
        </div>
      </div>
      <div class="row">
	  <div class="col-md-3">
              ...
              <form id="form-cadastro-usuario">
				...
				<label>Nível: </label>
					<select class ="form-control" name = "nivel" id ="nivel">
						<option value="<?php echo isset($usuario_selec) ? $usuario_selec['nivel'] : '1' ?>">Administrador / Funcionário</option>
						<option value="<?php echo isset($usuario_selec) ? $usuario_selec['nivel'] : '2' ?>">Professor</option>
				</select>
				</div>
  ...
  formUsuario.validate({
    ...
    submitHandler : function(form){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo URL_BASE;?>/control/usuario-controle.php?acao=cadastrar-usuario&ajax=true",
        data: dados,
        dataType: 'json',
